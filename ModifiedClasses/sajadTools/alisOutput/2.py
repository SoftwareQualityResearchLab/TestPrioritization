...
modify=[]
modifedClass = tuple(open("normalizedModifiedClasses", 'r'))
for f in modifedClass:
	if not f.isspace():
		modify.append(f.strip())


main_list[0].append("commit_count")
main_list[0].append("commiter_count")
main_list[0].append("numberOfReportedBugs");
